real  unowned, exclusive, nonexclusive, invalid;
@pre(invalid>=1);
exclusive = 0;
nonexclusive = 0;
unowned = 0;
...
while (1>=0,  ( ( ((((exclusive >= 0 and nonexclusive >= 0) and unowned >= 0))) and invalid >= 0) and ([(unowned, invalid, exclusive, nonexclusive),1]>=0))){
  ndif 
  {
    [assume(invalid >= 1)]{
