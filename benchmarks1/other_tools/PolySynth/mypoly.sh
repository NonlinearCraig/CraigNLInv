...
OUTPUT_FILE=outpus_template1.csv

echo "Benchmark,Result,Time (seconds)" > $OUTPUT_FILE
for name in ex1 ex2 ex3 ex4 ex4_001 cav13-1 cav13-2 unicycle cohencu circuit deter bound1 bound2 contrived transcend basin lyapunov motivate
do
