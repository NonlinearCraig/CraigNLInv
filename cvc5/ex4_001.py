...
if __name__ == "__main__":
    ...
    #pre1=(x+1)*(1-x)>=0
    pre1 = slv.mkTerm(Kind.MULT, slv.mkTerm(Kind.ADD,x,one), slv.mkTerm(Kind.SUB,one,x))
    ...
    loop1 = slv.mkTerm(Kind.MULT, slv.mkTerm(Kind.ADD, x, slv.mkReal(3)), slv.mkTerm(Kind.SUB, x, slv.mkReal(3)))
