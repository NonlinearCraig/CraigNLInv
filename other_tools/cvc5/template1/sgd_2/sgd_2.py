...
if __name__ == "__main__":
    ...
    post1=slv.mkTerm(Kind.MULT,slv.mkTerm(Kind.ADD,x,two),slv.mkTerm(Kind.SUB,five,x))
...
# /home/zhaoyx/anaconda3/envs/formal/bin/python /home/zhaoyx/PycharmProjects/syn_with_cvc5/ex4_2/ex4_2.py
# (
#   (define-fun inv-f ((x Real)) Bool (>= (+ x (* (/ (- 1) 3) (* x x))) (/ (- 10) 3)))
# )
# Consuming Time: 1.08518624 s
