...
for times=1:max_iter
    ...
    %solve constrain
    sdp_cons=Loop(ht_y,p_x,[ht_x,loop_cond_ineq],0,lambda,sdp_cons,y_vars,deltadegree,wi_xy_degree);
    sdp_var = sdp_cons{2};
    ...
    sdp_cons{1}=vars;
    sdp_cons=Loop(-h_x*wht_xy+h_y,p_x,[loop_cond_ineq],0,0,sdp_cons,y_vars,deltadegree,wi_xy_degree);
    %solve constrainte
    sdp_var = sdp_cons{2};
    constraints = sdp_cons{3};
